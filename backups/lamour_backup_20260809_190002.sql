...
\restrict R1vi8UoIxSi97UfqKoDLg3EBn2EbvCYzgEldlHJwQhfwhDX1D5YWcm8hQpFO3Cu
...
1	t	02:00:00	30	2026-07-28 02:00:52.928643+07	1	/Users/haiphan/Desktop/haiphan/be-window-lamour/backups
\.
...
COPY public.payment_entries ("Id", "PaymentId", "Description", "DebitAccount", "CreditAccount", "Amount", "SubjectCode", "SubjectName", "BankAccount") FROM stdin;
\.
...
COPY public.payments ("Id", "SupplierId", "PayeeName", "Address", "PaymentReason", "PaymentEmployeeId", "Attachment", "Reference", "AccountingDate", "DocumentDate", "DocumentNumber", "CreatedAt") FROM stdin;
\.
...
COPY public.sales_order_lines (id, sales_order_id, product_id, product_code, product_name, is_promotion, unit, quantity, unit_price, amount, receivable_account, revenue_account, discount_rate, tax_amount, tax_rate, is_amount_manual) FROM stdin;
1	1	1	SP001	Skin Hydration Gel Toner	f	Chai	2	1200000.00	2400000.00	131	511	0.00	192000.00	8.00	f
2	1	3	SP003	Centella TC Cream	f	Hộp	3	650000.00	1852500.00	131	511	5.00	148200.00	8.00	f
3	2	4	SP004	Sữa rửa mặt Cocoon	f	Chai	5	280000.00	1400000.00	131	511	0.00	70000.00	5.00	f
4	2	5	SP005	Mặt nạ dưỡng ẩm	f	Miếng	10	45000.00	450000.00	131	511	0.00	45000.00	10.00	f
5	3	2	SP002	Time Reset Serum	f	Chai	1	2160000.00	1944000.00	131	511	10.00	155520.00	8.00	f
6	3	6	SP006	Kem chống nắng SPF50	f	Tuýp	2	420000.00	840000.00	131	511	0.00	67200.00	8.00	f
7	4	8	SP008	Tinh chất Vitamin C	f	Chai	2	1450000.00	2900000.00	131	511	0.00	0.00	0.00	f
8	4	7	SP007	Combo quà tặng dùng thử	t	Bộ	1	0.00	0.00	131	511	0.00	0.00	0.00	f
9	5	1	SP001	Skin Hydration Gel Toner	f	Chai	4	1200000.00	4800000.00	131	511	0.00	384000.00	8.00	f
10	5	5	SP005	Mặt nạ dưỡng ẩm	f	Miếng	20	45000.00	900000.00	131	511	0.00	90000.00	10.00	f
22	7	4	SP004	Sữa rửa mặt Cocoon	f	Chai	1	280000.00	280000.00	131	511	0.00	14000.00	5.00	f
23	6	3	SP003	Centella TC Cream	t	Hộp	1	0.00	0.00	131	511	0.00	0.00	0.00	f
24	6	7	SP007	Combo quà tặng dùng thử	t	Bộ	1	0.00	0.00	131	511	0.00	0.00	0.00	f
25	8	1	SP001	Skin Hydration Gel Toner	f	Chai	1	1200000.00	1200000.00	131	511	0.00	96000.00	8.00	f
26	8	5	SP005	Mặt nạ dưỡng ẩm	t	Miếng	1	0.00	0.00	131	511	0.00	0.00	0.00	f
29	11	2	SP002	Time Reset Serum	f	Chai	1	2160000.00	2160000.00	131	511	0.00	172800.00	8.00	f
30	9	4	SP004	Sữa rửa mặt Cocoon	t	Chai	1	0.00	0.00	131	511	0.00	0.00	0.00	f
31	9	8	SP008	Tinh chất Vitamin C	f	Chai	1	1450000.00	1450000.00	131	511	0.00	0.00	0.00	f
32	10	8	SP008	Tinh chất Vitamin C	f	Chai	1	1450000.00	1450000.00	131	511	0.00	0.00	0.00	f
33	12	7	SP007	Combo quà tặng dùng thử	f	Bộ	1	0.00	0.00	131	511	0.00	0.00	0.00	f
\.
...
COPY public.sales_return_lines (id, sales_return_id, product_id, product_code, product_name, return_account, debt_account, discount_account, unit, quantity, unit_price, amount, discount_rate, discount_amount, sales_order_number) FROM stdin;
1	1	3	SP003	Centella TC Cream	5212	131	5211	Hộp	1	650000.00	650000.00	5.00	32500.00	\N
\.
...
SELECT pg_catalog.setval('public.account_settings_id_seq', 40, false);
...
\unrestrict R1vi8UoIxSi97UfqKoDLg3EBn2EbvCYzgEldlHJwQhfwhDX1D5YWcm8hQpFO3Cu
