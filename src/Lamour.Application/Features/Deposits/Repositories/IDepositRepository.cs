...
public interface IDepositRepository
{
    ...
    Task<IEnumerable<Deposit>> GetByCustomerIdAsync(int customerId, int? excludeSalesOrderId = null, CancellationToken ct = default);
    Task<IEnumerable<Deposit>> GetEligibleForDeductionAsync(int customerId, int? excludeSalesOrderId = null, CancellationToken ct = default);
