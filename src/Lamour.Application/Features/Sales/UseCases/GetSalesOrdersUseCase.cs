...
public class GetSalesOrdersUseCase : IGetSalesOrdersUseCase
{
    ...
    internal static SalesOrderResponseDto MapToDto(Domain.Entities.SalesOrder o) => new()
    {
        ...
        CustomerNameOverride = o.CustomerNameOverride,
        CustomerAddress = o.CustomerAddressOverride ?? o.Customer?.Address ?? "",
        CustomerAddressOverride = o.CustomerAddressOverride,
